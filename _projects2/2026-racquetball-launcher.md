...
<iframe src="{{ '/assets/pdf/racquetball_FA25_SP26.pdf' | relative_url }}" width="120%" margin-left="-10%" height="900px">
    This browser does not support PDFs. Please download the PDF to view it: 
    <a href="{{ '/assets/pdf/racquetball_FA25_SP26.pdf' | relative_url }}">Download PDF</a>
</iframe>